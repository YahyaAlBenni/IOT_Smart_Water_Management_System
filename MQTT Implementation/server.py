...
def on_message(client, userdata, msg):
    ...
    if topic == "user/request": #-------user press R to get sensors data-------
        ...
        if payload == "get_sensor_data":
            ...
            """
            client.publish("user/response", response) #-------if user press R, Publish all Sensors Data-------

    else: #-------process sensor data and notify user if needed-------
